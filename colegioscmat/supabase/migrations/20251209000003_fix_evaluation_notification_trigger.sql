-- =====================================================
-- FIX: Triggers de notificaciones
-- Problema: user_id puede ser NULL en algunos casos
-- Solución: Verificar que user_id existe antes de crear notificaciones
-- =====================================================
...
-- Los triggers ya existen, solo actualizamos las funciones
COMMENT ON FUNCTION audit_evaluation_changes() IS 
  'Auditoria cambios en evaluaciones y notifica cuando se publican. Solo crea notificaciones si el estudiante tiene user_id.';
  
COMMENT ON FUNCTION notify_justification_status() IS 
  'Auditoria cambios en justificaciones y notifica al apoderado. Solo crea notificaciones si el apoderado tiene user_id.';
