...
export function GuardianEvaluationPage() {
  ...
  async function loadStudents() {
    try {
      ...
      // Obtener guardian ID del usuario actual
      ...
      // Obtener hijos del apoderado a través de student_guardians
  ...
  async function loadPeriodsAndEvaluations() {
    try {
      setLoading(true);
      ...
      const { data: periodsData, error: periodsError } = await supabase
        ...
        .eq('academic_year_id', student.section.academic_year_id)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#0F172A] mb-2">Calificaciones</h1>
          <p className="text-[#334155]">Revisa el rendimiento académico de tus hijos</p>
        </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-[#334155]">
                Los docentes aún no han publicado calificaciones para el periodo seleccionado
              </p>
            </div>
          </CardContent>
        </Card>
